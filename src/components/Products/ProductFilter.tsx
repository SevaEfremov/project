    ...
    <div className="bg-white rounded-lg shadow-md p-4 mb-6">
      ...
      <div className={`mt-4 ${showFilters ? 'block' : 'hidden md:block'}`}>
        <div className="flex justify-between items-center mb-4">
          <h3 className="font-semibold text-gray-900">Фильтр</h3>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <h4 className="font-medium text-sm mb-2 text-gray-700">Категории</h4>
          ...
          <div>
            <h4 className="font-medium text-sm mb-2 text-gray-700">Цена </h4>
            <div className="px-2">
          ...
          <div className="md:hidden">
            <h4 className="font-medium text-sm mb-2 text-gray-700">Сортировать по:</h4>
            <select
              value={sortOption}
              onChange={(e) => onSortChange(e.target.value)}
