...
const CartSummary: React.FC<CartSummaryProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h2 className="text-xl font-semibold mb-4 text-gray-800">Общая сумма</h2>
      ...
      >
        ...
        <span>Нажмите для оплаты</span>
      </button>
      
      <div className="mt-6">
        <h3 className="text-sm font-medium text-gray-700 mb-2">Способы оплаты</h3>
      ...
      <div className="mt-4 text-sm text-gray-500 flex items-center">
        ...
        <span>Бесплатная доставка начинается от $100</span>
      </div>
    </div>
  );
};
